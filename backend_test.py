...
class BackendTester:
    def __init__(self, base_url: str = "https://0feae617-4ff3-44b4-989b-86c0e4117cd2.preview.emergentagent.com"):
...
if __name__ == "__main__":
    ...
    backend_url = sys.argv[1] if len(sys.argv) > 1 else "https://0feae617-4ff3-44b4-989b-86c0e4117cd2.preview.emergentagent.com"
