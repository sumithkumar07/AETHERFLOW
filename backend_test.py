...
BACKEND_URL = "https://d69f8acf-a9d8-4a69-8b2c-42ec541a0e10.preview.emergentagent.com"
...
class VibeCodeAPITester:
    ...
    async def run_all_tests(self):
        ...
        try:
            ...
            await self.test_cosmic_reality_metrics()
            await self.test_cosmic_status()
            await self.test_code_evolution()
            await self.test_karma_reincarnation()
            await self.test_digital_archaeology()
            await self.test_code_immortality()
            await self.test_nexus_events()
            await self.test_cosmic_debugging()
            await self.test_vibe_token_balance()
            await self.test_vibe_token_transaction()
            await self.test_cosmic_utilities()
