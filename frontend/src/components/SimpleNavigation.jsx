          ...
          <div className="flex items-center space-x-3">
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  Get Started Free
                </Link>
              </div>
